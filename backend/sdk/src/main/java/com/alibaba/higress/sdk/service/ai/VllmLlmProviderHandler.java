...
public class VllmLlmProviderHandler extends AbstractLlmProviderHandler {

    private static final String CUSTOM_URL_KEY = "vllmCustomUrl";
    private static final String EXTRA_CUSTOM_URLS_KEY = "vllmExtraCustomUrls";
    ...
    public void normalizeConfigs(Map<String, Object> configurations) {
        ...
        if (CollectionUtils.isEmpty(customUris)) {
            throw new ValidationException("No vLLM service URL is configured.");
        }
